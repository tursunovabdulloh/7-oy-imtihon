...
function Products() {
  const dispatch = useDispatch();
  const { filteredData, products } = useSelector((state) => state.cart);
  const [currentPage, setCurrentPage] = useState(1);
  const productsPerPage = 18;
  const { data, error, isLoading, isSuccess } = useGetProductsQuery({
    limit: productsPerPage,
                              ...
                              {productInCart ? (
                                <div className="flex gap-2">
                                  <button
                                    ...
                                    className="btn btn-primary min-h-0 w-[35px]   mb-2"
                                  >
                                    -
                                  </button>
                                  <div className="text-[#463AA1] font-[Segoe UI] w-[35px] text-center pt-2">
                                  ...
                                  <button
                                    ...
                                    className="btn btn-primary min-h-0 w-[35px] p-[7.5px]  mb-2"
                                  >
                                    +
                                  </button>
                                </div>
